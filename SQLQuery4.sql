...
--DROP TABLE CORS
------------------------------------------------------------------------------------------------------------------------------
--O QUE N�O EST� NAS DUAS TABELAS?
------------------------------------------------------------------------------------------------------------------------------
--VIEWS DIFERENCA_CORS_EXT -> MOSTRA O QUE N�O TEM DE CORS EM EXTRACT
...
--VIEWS DIFERENCA_EXT_CORS -> MOSTRA O QUE N�O TEM DE EXTRACT EM CORS
	SELECT * FROM EXTRACT
...
------------------------------------------------------------------------------------------------------------------------------
--O QUE EST� NAS DUAS TABELAS?
------------------------------------------------------------------------------------------------------------------------------
--VIEWS CORS_EXT -> MOSTRA O QUE EST� NAS DUAS TABELAS
